<?php
	...
	Class AcctCreditsHasntPaidReport extends CI_Controller{
		...
		public function processPrinting($sesi){
			...
			$acctcreditsaccount	= $this->AcctCreditsHasntPaidReport_model->getCreditsAccount($sesi['start_date'],$sesi['end_date'], $branch_id);
			...
			<br/>
				<table cellspacing=\"0\" cellpadding=\"1\" border=\"0\">
				    <tr>
				        <td><div style=\"text-align: center; font-size:14px\">DAFTAR NASABAH BELUM MENGANGSUR " .tgltoview($sesi['start_date']). " S.D ".tgltoview($sesi['end_date'])."</div></td>
				    </tr>
		...
		public function export($sesi){	
			...
			if(count($acctcreditsaccount) !=0){
				...
				$this->excel->getActiveSheet()->setCellValue('B1',"DAFTAR NASABAH BELUM MENGANGSUR ".tgltoview($sesi['start_date'])." S.D ".tgltoview($sesi['end_date']));					
